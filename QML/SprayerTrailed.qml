...
Item {
    ...
    Image {
        ...
        source: "qrc:/Image/trailedSprayerAnfas.png"
    }
    ...
    Image {
        ...
        y: namePage.y + namePage.height + 35
        source: "qrc:/Image/trailedSprayerUpview.png"
    }

    Image {
        id: _infoSprayer
        source: "qrc:/Image/infoTrailedSprayer.png"
        anchors{
    ...
    ListModel{
        ...
        ListElement{name: ""; objectName: "TrailedSprayerH"; leftText: "H"; mask: "00"}
        ListElement{name: ""; objectName: "TrailedSprayerS"; leftText: "±S"; mask: "#00"}
        ListElement{name: ""; objectName: "TrailedSprayerL"; leftText: "L"; mask: "00"}
    }
